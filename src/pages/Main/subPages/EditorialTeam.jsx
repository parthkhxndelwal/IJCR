...
export default function EditorialTeam({ chooseSubPage }) {
        ...
        <>  
            ...
            <div className='EditorialTeam'>
                ...
                <div className="ManagingEditor">
                    ...
                    <h3><button id='teamMemberRedirectButton' onClick={() => chooseSubPage('Nitish Kumar Minz')}>Mr. Nitish Kumar Minz</button></h3>
                </div>
